...
class MathFlutter {
  ...
  static void setupSurveyUrlListener() {
    _channel.setMethodCallHandler((call) async {
      if (call.method == 'onSurveyUrlReceived') {
        ...
        if (url.isNotEmpty) onSurveyUrlReceived?.call(url);
      }
    });
  }
  ...
  static Future<String> init({
    ...
    return await _channel.invokeMethod<String>(
          'initialize',
          {'apiKey': apiKey, 'dataCenter': dataCenter.value},
        ) ??
        'SDK initialized';
  }
  ...
  static Future<String> setScreenVisited(String screenName) async {
    ...
    return await _cxChannel.invokeMethod<String>(
          'setScreenVisited',
  ...
  static Future<String> setDataMappings(
      Map<String, String> customVariables) async {
    return await _channel.invokeMethod<String>(
          'setDataMappings',
