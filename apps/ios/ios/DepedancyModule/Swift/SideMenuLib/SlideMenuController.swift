...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = DeviceMatrixHelper.isIpad ? 580.0 : 270.0
...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
        ...
        if leftViewController != nil {
            ...
            //iPhone X specific check
            if UIDevice().userInterfaceIdiom == .phone &&  UIScreen.main.nativeBounds.height == 2436 {
                if #available(iOS 11.0, *) {
                    leftFrame = view.safeAreaLayoutGuide.layoutFrame
                }
                leftFrame.origin.y = 30
                leftFrame.size.height = leftFrame.size.height-44
            } else {
...
extension UIViewController {
    ...
    @objc public func setNavigationBarItem(leftImageName : String, rightImageName : String, titleText : String, enableRightButton : Bool) {
    ...
    @objc public func addRightBarButtonWithImage(_ buttonImage: UIImage) {
