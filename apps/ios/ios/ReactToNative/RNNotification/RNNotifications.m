...
- (NSArray<NSString*> *)supportedEvents {
    ...
    return @[@"remoteNotificationsRegistered", @"remoteNotificationsRegistrationFailed", @"pushKitRegistered", @"notificationReceivedForeground", @"notificationReceivedBackground", @"notificationOpened", @"notificationActionReceived"];
}
...
//    [RNNotificationsBridgeQueue sharedInstance].openedLocalNotification = [bridge.launchOptions objectForKey:UIApplicationLaunchOptionsLocalNotificationKey];
//}
...
- (void)handleNotificationsRegistrationFailed:(NSNotification *)notification
{
    ...
    [self sendEventWithName:@"remoteNotificationsRegistrationFailed" body:notification.userInfo];
...
- (void)handlePushKitRegistered:(NSNotification *)notification
{
    ...
    [self sendEventWithName:@"pushKitRegistered" body:notification.userInfo];
...
- (void)handleNotificationReceivedForeground:(NSNotification *)notification
{
    ...
    [self sendEventWithName:@"notificationReceivedForeground" body:notification.userInfo];
...
- (void)handleNotificationReceivedBackground:(NSNotification *)notification
{
    ...
    [self sendEventWithName:@"notificationReceivedBackground" body:notification.userInfo];
...
- (void)handleNotificationOpened:(NSNotification *)notification
{
    ...
    [self sendEventWithName:@"notificationOpened" body:notification.userInfo];
