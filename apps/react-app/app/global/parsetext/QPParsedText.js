...
import QPTextExtraction from './QPTextExtraction';
...
class QPParsedText extends React.Component {
  ...
  getParsedText() {
    ...
    const textExtraction = new QPTextExtraction(this.props.children, this.getPatterns());
