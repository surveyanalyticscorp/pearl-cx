...
export default class ModalDropdown extends Component {
  ...
  _calcPosition() {
    ...
    let multiplier = this.props.options.length >=4 ? 5: (this.props.options.length+0.5);
    let height = 33 * multiplier;
    ...
    let showInBottom = bottomSpace >= (dropdownHeight + 100) || bottomSpace >= (this._buttonFrame.y + 100);
  ...
  _onRowPress(rowData, sectionID, rowID, highlightRow) {
    if (!this.props.onSelect ||
      ...
      console.log(rowID + "-> " + rowData.name);
