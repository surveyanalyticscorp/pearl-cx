...
const CB_ENABLED_IMAGE = (Platform.OS != 'ios') ? require('./checkbox_checked.png') :{uri:'checkbox_checked.png'};
const CB_DISABLED_IMAGE = (Platform.OS != 'ios') ? require('./checkbox_unchecked.png') :{uri:'checkbox_unchecked.png'};
        ...
        let container = (
            <View style={this.props.containerStyle || styles.container}>
                ...
                <View style={styles.labelContainer}>
                    {this.props.renderLabel()  || <Text style={[styles.label, this.props.labelStyle]}>{this.props.label}</Text>}
                </View>
            </View>
        );
        ...
        if (this.props.labelBefore) {
            container = (
                <View style={this.props.containerStyle || [styles.container, styles.flexContainer]}>
                    <View style={styles.labelContainer}>
                        {this.props.renderLabel() ||  <Text numberOfLines={this.props.labelLines} style={[styles.label, this.props.labelStyle]}>{this.props.label}</Text>}
                    </View>
                    <Image
...
CheckBox.propTypes = {
    ...
    checkedImage: PropTypes.oneOfType([PropTypes.array,PropTypes.object,PropTypes.number]),
    uncheckedImage: PropTypes.oneOfType([PropTypes.array,PropTypes.object,PropTypes.number]),
