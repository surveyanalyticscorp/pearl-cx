...
export default class ModuleCategoryList extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <OnTouchHighlightWidget onPress={() => {
                ...
                <View
                    ...
                    <CustomText style={styles.rowText}>{item[`${countLabel}`]}</CustomText>
                </View>
...
// ModuleCategoryList.propTypes={
//     categories : React.PropTypes.array,
//     totalCount : React.PropTypes.number,
//     itemLabel : React.PropTypes.string,
//     countLabel : React.PropTypes.string,
