...
export default class SurveyCategoryList extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderRow({item}) {
        const {itemLabel, countLabel, selectAction, routeKey} = this.props;
        const showArrow = routeKey === '3';
        return (
            <OnTouchHighlightWidget onPress={() => {
                ...
                <View
                    ...
                    {!showArrow && <Icon name="keyboard-arrow-right" color={"#d8d8d8"} size={30}/>}
                </View>
