...
const Swipeout = createReactClass({
  ...
  componentWillMount: function() {
    this._panResponder = PanResponder.create({
      ...
      onMoveShouldSetPanResponderCapture: (event, gestureState) =>
        this._canMove(event, gestureState) &&
  ...
  componentWillReceiveProps: function(nextProps) {
    if (nextProps.close) this._close(3);
  ...
  _handlePanResponderGrant: function(e: Object, gestureState: Object) {
    ...
    this.props.grant && this.props.grant();
  },

  _handlePanResponderMove: function(e: Object, gestureState: Object) {
    if (this.props.disabled || !this._canMove(e, gestureState)) return;
    ...
    // TODO Reswipping
    // if (this.openedRight) var posX = gestureState.dx - rightWidth;
    // else if (this.openedLeft) var posX = gestureState.dx + leftWidth;
    ...
    if (this.props.scroll) {
      if (moveX) {
        ...
        vX <= maxVx &&
          this.props.swipe(this.state.openedLeft, this.state.openedRight, Math.abs(posX), Math.abs(gestureState.vx));
  ...
  _handlePanResponderEnd: function(e: Object, gestureState: Object) {
    ...
    //  Allow scroll
    if (this.props.scroll && vX <= maxVx) this.props.scroll(true);
  },

  _canMove: function(evt, gestureState) {
    return (
  ...
  _tweenContent: function(state, endValue) {
    this.tweenState(state, {
      ...
      duration: endValue === 0 ? 0 : this.state.tweenDuration,
      endValue: endValue
    });
  },
  ...
  _autoClose: function(btn) {
    if (this.state.autoClose) this._close(1);
  ...
  _close: function(number) {
    //console.log('_close', number);
  ...
  render: function() {
    ...
    return (
      <View style={styleSwipeout}>
        <View ref="swipeoutContent" style={styleContent} onLayout={this._onLayout} {...this._panResponder.panHandlers}>
          {this.props.children}
        </View>
