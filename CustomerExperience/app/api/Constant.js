...
export const CX_GET_RESET_PASSWORD_LINK = '/a/nativehtml/cx.auth.CXForgotPasswordLink';
export const CX_VALIDATE_PASSWORD_LINK = '/a/nativehtml/cx.auth.ValidatePasswordLinkExpiry';
...
export const CX_GET_CLOSED_LOOP_TICKET_DETAILS = '/a/nativehtml/cx.closedloop.CXGetTicketDetails';
export const CX_GET_CLOSED_LOOP_SEGMENT_DETAILS = '/a/nativehtml/cx.closedloop.CXGetSegmentByStatus';
export const CX_GET_CLOSED_LOOP_OWNER_DETAILS = '/a/nativehtml/cx.closedloop.CXGetOwnerBySegment';
export const CX_UPDATE_CLOSED_LOOP_TICKET = '/a/nativehtml/cx.closedloop.CXUpdateTicket';
export const CX_ADD_CLOSED_LOOP_TICKET = '/a/nativehtml/cx.CXAddTicket';

export const CX_GET_NOTIFICATION_LIST = '/a/nativehtml/cx.CXGetNotificationLogs';
export const CX_CLEAR_NOTIFICATION_LOGS = '/a/nativehtml/cx.CXClearNotificationLogs';
